...
const FIELD_HELP: Record<string, string> = {
  ...
  "tools.web.search.provider": 'Search provider ("brave", "perplexity", or "bocha").',
  "tools.web.search.apiKey": "Search API key (Brave: BRAVE_API_KEY, Bocha: BOCHA_API_KEY env var).",
  "tools.web.search.maxResults":
    "Default number of results to return (1-10 for brave/perplexity, 1-50 for bocha).",
